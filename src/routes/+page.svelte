<script>
	...
	// Enforce sandstone-70 when visiting home
	bgTheme.set('sandstone-70');
...
{#if pageReady}
	...
	<section bind:this={heroSection} class="relative h-[500px] mb-8 overflow-hidden">
		...
		/>
		<div class="absolute inset-0 bg-gradient-to-b from-wow-navy/80 via-wow-navy/65 to-wow-navy/70" />

		<div class="flex relative z-10 items-center h-full">
			<div class="px-6 mx-auto w-full md:w-3/4">
				<h1 class="text-4xl font-bold md:text-5xl text-wow-offwhite" style="font-family: Cinzel, serif;">WoW Tools</h1>
				<p class="mt-3 max-w-2xl text-wow-lightgold">Tools and news for adventurers across Azeroth.</p>
			</div>
		</div>
	</section>
	...
	<div class="px-6 pb-6 w-full">
		<div class="mx-auto w-full md:w-3/4">
			<div use:reveal class="p-4 rounded-xl border backdrop-blur-sm border-wow-gold/30 bg-wow-parchment/90 shadow-[0_2px_8px_rgba(0,0,0,0.15)]">
	...
	<div class="p-6 mx-auto mt-8 w-full md:w-3/4">
		<!-- Feature Cards -->
		<div use:reveal class="p-4 mb-12 rounded-xl border backdrop-blur-sm border-wow-gold/20 bg-white/40">
			<div
				class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4"
			>
			<Card href="/trinkets" class="!bg-wow-navy/90 hover:!bg-wow-teal transition-all duration-200 ease-in-out border border-wow-gold/30 hover:scale-[1.02] shadow-[0_2px_8px_rgba(0,0,0,0.15)]">
				<h3
