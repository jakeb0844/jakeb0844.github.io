function Ne(e, r) {
  ...
  for (; n--; ) {
    const i = e[n],
      s = r[n];
    if (s) {
      for (const c in i) c in s || (o[c] = 1);
      for (const c in s) l[c] || ((t[c] = s[c]), (l[c] = 1));
      e[n] = s;
    } else for (const c in i) l[c] = 1;
  }
...
const B = "-",
  ...
  Y = (e, r) => {
    ...
    const t = e[0],
      o = r.nextPart.get(t),
      l = o ? Y(e.slice(1), o) : void 0;
    if (l) return l;
    if (r.validators.length === 0) return;
    const n = e.join(B);
    return (i = r.validators.find(({ validator: s }) => s(n))) == null
      ? void 0
      : i.classGroupId;
  },
  K = /^\[(.+)\]$/,
  ...
  se = (e) => {
    ...
    return (
      le(Object.entries(e.classGroups), t).forEach(([n, i]) => {
        O(i, o, n, r);
      }),
      o
    );
      ...
      ? e.map(([t, o]) => {
          const l = o.map((n) =>
            typeof n == "string"
              ...
              : typeof n == "object"
              ? Object.fromEntries(
                  Object.entries(n).map(([i, s]) => [r + i, s])
                )
              : n
          );
          return [t, l];
  ...
  pe = (e) => ({ cache: ae(e.cacheSize), parseClassName: ce(e), ...oe(e) }),
  ue = /\s+/,
  be = (e, r) => {
    const {
        parseClassName: t,
...
function fe(e, ...r) {
  ...
  function i(c) {
    ...
    return (t = pe(g)), (o = t.cache.get), (l = t.cache.set), (n = s), s(c);
  }
  function s(c) {
    const g = o(c);
    if (g) return g;
...
const d = (e) => {
  ...
  Le = fe(Ee);
export { Te as a, Ne as g, Le as t };
