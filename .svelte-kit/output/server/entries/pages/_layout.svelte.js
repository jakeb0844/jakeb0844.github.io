        ...
        return `${validate_component(NavContainer, "NavContainer").$$render(
          ...
          {},
          {
            default: () => {
              return `${
                slots.default
                  ? slots.default({ hidden: $hidden, toggle, NavContainer })
                  : ``
              }`;
            },
          }
...
const NavHamburger = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
...
const NavLi = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.href === void 0 && $$bindings.href && href !== void 0)
    $$bindings.href(href);
  if (
    $$props.activeClass === void 0 &&
    $$bindings.activeClass &&
    activeClass !== void 0
  )
    $$bindings.activeClass(activeClass);
  if (
    $$props.nonActiveClass === void 0 &&
    $$bindings.nonActiveClass &&
    nonActiveClass !== void 0
  )
...
const NavUl = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let {
    ulClass = "flex flex-col p-4 mt-4 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:text-sm md:font-medium",
  } = $$props;
  ...
  $$unsubscribe_hiddenStore = subscribe(
    hiddenStore,
    (value) => ($hiddenStore = value)
  );
  let _hidden;
  let _divClass;
  let _ulClass;
  if (
    $$props.activeUrl === void 0 &&
    $$bindings.activeUrl &&
    activeUrl !== void 0
  )
  ...
  if (
    $$props.slideParams === void 0 &&
    $$bindings.slideParams &&
    slideParams !== void 0
  )
  ...
  return `${
    !_hidden
      ...
      : `<div${spread(
          ...
          {}
        )}><ul${add_attribute("class", _ulClass, 0)}>${
          slots.default ? slots.default({}) : ``
        }</ul></div>`
  } `;
});
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="min-h-screen bg-white dark:bg-gray-900">${validate_component(
    Navbar,
    "Navbar"
  ).$$render(
    $$result,
    ...
    {},
    {
      default: () => {
        return `${validate_component(NavBrand, "NavBrand").$$render(
          ...
          {
            default: () => {
              return `<span class="self-center whitespace-nowrap text-xl font-semibold dark:text-white" data-svelte-h="svelte-1jvbxts">WoW Tools</span>`;
            },
          }
