...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="min-h-screen bg-white dark:bg-gray-900">${validate_component(Navbar, "Navbar").$$render($$result, {}, {}, {
    default: () => {
  ...
  })} <main class="w-full">${slots.default ? slots.default({}) : ``}</main></div>`;
});
export {
  Layout as default
};
